...
<body>
	...
	<section class="main-container">
		<div class="main-wrapper">
			<h2><center>Add Vehicles</center></h2>
			<form class="manage-form" action="Includes/manage_vehicle-inc.php" method="POST" enctype="multipart/form-data">
				<input type="text" name="name" placeholder="Name">
				<input type="number" min="0" name="price" placeholder="Price">
				<input type="text" name="type" placeholder="Type">
				<textarea name="description" placeholder="Description"></textarea>
				<input type="number" min="0" name="avb" placeholder="Availability">
		...
		<div class="main-wrapper">
			<h2><center>Delete/Modify Vehicles</center></h2>
			<form class="manage-form" action="Includes/manage_vehicle-inc.php" onsubmit="return confirmation();" method="POST">
				<input type="text" name="name" placeholder="Name">
