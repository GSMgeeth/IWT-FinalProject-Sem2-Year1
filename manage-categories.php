...
<body>
	...
	<section class="main-container">
		<div class="main-wrapper">
			<h2><center>Add categories</center></h2>
			<form class="manage-form" action="Includes/manage_category-inc.php" method="POST" enctype="multipart/form-data">
		...
		<div class="main-wrapper">
			<h2><center>Delete/Modify categories</center></h2>
			<form class="manage-form" action="Includes/manage_category-inc.php" onsubmit="return confirmation();" method="POST">
				<input type="text" name="name" placeholder="Name">
