...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="links"><a>Sign up</a><br><a>Log in</a></div>
        </div>
        <div class="navi">
            <ul>
                <li class="navi_active ">Home</li>
                <li class="navi_inactive"><a href="#">Categories</a></li>
                <li class="navi_inactive"><a href="#">Packages</a></li>
                <li class="navi_inactive"><a href="#">Vehicles</a></li>
            ...
            <div class="coresel">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item">
                            <img src="Images/image6.jpg" alt="Flower">
                        </div>
                        <div class="item">
                            <img src="Images/image7.jpg" alt="Flower">
                        </div>
                        <div class="item">
                            <img src="Images/image8.jpg" alt="Flower">
                        </div>
                    </div>
